...
public class DriverFactory {
    ...
    public static void initDriver() {
        ...
        if (java.util.Objects.equals(propertyManager.getProperty("BROWSER"), "REMOTE")) {
            initRemoteDriver();
            return;
        }
        ...
        Configuration.headless = java.util.Objects.equals(propertyManager.getProperty("HEADLESS"), "Y");

        browser = java.util.Objects.equals(propertyManager.getProperty("BROWSER"), null) ? "chrome" : propertyManager.getProperty("BROWSER");
